...
import {Form, Select, Button, AutoComplete, message} from 'antd';
...
class Activities4 extends React.Component {
    ...
    handleSubmit = (e) => {
        ...
        let obj = {
            ...
            VisitUnit: this.props.Activities.value["Visi the unit"],
            ...
            TitlePosition: this.props.Activities3.value["Adults"],
            Status: this.props.Activities3.value["Adults"],
            /*    Creator: ""string"",*/
    ...
    render() {
        ...
        /*第三个页面*/
        let values3 = this.props.Activities3.value;
