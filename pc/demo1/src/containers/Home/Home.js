...
import './NearTermActivities';
import {Carousel, Calendar, Form, Icon} from 'antd';
...
//year 年份  month月份
    ...
    render() {
        ...
        let GetExternalWebpage = this.state.GetExternalWebpage;

        // console.log(GetExternalWebpage);
        return (<div>
            {/*轮播图片*/}
            <div>
                <Carousel autoplay>
                            ...
                            <div className="zAccountPlanL span5 no-margin-left">
                                <div className="WdateDiv" style={{width: "548px"}}>
                                    <div className="dpTitle">
                                        <div className="dBTop">
                                            <p className="time">{this.state.year}
